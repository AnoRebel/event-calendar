...
// Accepts any readable ref of events (a `computed` in the views, a plain `ref`
// in tests) — the composable only ever reads `events.value`.
export function useEventStatus(events: Readonly<Ref<CalendarEvent[]>>) {
